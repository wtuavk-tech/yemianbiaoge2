               ...
               <thead className="sticky top-0 z-10 shadow-sm">
                  <tr>
                    {config.headers.map((h, i) => (
                      <th 
                        key={i} 
                        className="bg-white px-4 py-3 text-[13px] font-bold text-slate-700 border-b border-[#cbd5e1] last:border-r-0 whitespace-nowrap group relative"
                      >
                    ...
                    <th className="bg-white px-4 py-3 text-[13px] font-bold text-slate-700 border-b border-[#cbd5e1] whitespace-nowrap sticky right-0 z-20 shadow-[-10px_0_10px_-5px_rgba(0,0,0,0.05)]">
                      操作
                    </th>
                  </tr>
               </thead>
